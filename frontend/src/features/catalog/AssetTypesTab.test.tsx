...
const type = (id: string, name: string, categoryId: string | null, role = 'device'): never =>
  ({ id, code: id, name, group: null, role, categoryId, isContainer: false, fieldTemplate: null, requiredToCreate: null, iconName: null, displayColor: null, placementKind: null, connectionKind: null, sortOrder: 0, isActive: true }) as never;
