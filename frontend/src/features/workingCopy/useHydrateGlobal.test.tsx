...
function wrap() {
  ...
  qc.setQueryData(['assets-slim'], [
    { id: 'a1', name: 'OFD', substationId: 's1', substationName: '춘천', parentAssetId: null, role: 'ofd', code: 'OFD', slotIndex: null },
    { id: 'a2', name: '단말', substationId: 's2', substationName: '북춘천', parentAssetId: null, role: 'device', code: 'OPT-COT', slotIndex: null },
  ]);
