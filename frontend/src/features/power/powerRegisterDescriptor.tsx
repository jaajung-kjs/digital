  ...
  columns: [
    {
      label: '번호',
      width: 'w-14',
      cell: (r) => <span className="tabular-nums text-content-muted">{r.cbNumber || <span className="text-content-faint">—</span>}</span>,
    },
    {
      label: '부하',
      cell: (r) => (
    ...
    },
    {
      label: '용량',
      width: 'w-20',
      cell: (r) => <span className="text-content-muted">{r.capacity || <span className="text-content-faint">—</span>}</span>,
    },
    {
      label: '규격',
      cell: (r) => (
        ...
        return r.switchState
          ? (
            <span className="inline-flex items-center gap-1.5">
              ...
              <span className={on ? 'text-content' : 'text-content-faint'}>{r.switchState}</span>
            </span>
          )
