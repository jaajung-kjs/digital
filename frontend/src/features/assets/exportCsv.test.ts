...
// #7: Asset.attributes 제거 — 컬럼은 이름만.
const cols: GridColumn[] = [
  { key: 'name', label: '이름', kind: 'name' },
];
const assets = [
  { id: 'a1', name: '원주RTU', installDate: '2023-12-01', manager: '김OO', status: '운영', warrantyUntil: null, replaceDue: null, assetType: { name: 'RTU' } } as unknown as Asset,
];
