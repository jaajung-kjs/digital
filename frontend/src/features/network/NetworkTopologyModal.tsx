      ...
      >
        ...
        <div className="bg-surface-2 px-2.5 py-1.5 border-b border-line">
          <div className="flex items-center justify-between">
            ...
            {tier === 'junction' && (
              <span className="ml-1 shrink-0 text-xs text-amber-600 font-medium">분기점</span>
            )}
          </div>
        </div>
  ...
  return createPortal(
    ...
    >
      <div className="bg-surface rounded-lg shadow-xl w-[min(1200px,95vw)] h-[min(800px,90vh)] flex flex-col">
        ...
        <div className="px-4 py-2 border-t border-line flex items-center gap-4 text-xs text-content-muted flex-wrap">
