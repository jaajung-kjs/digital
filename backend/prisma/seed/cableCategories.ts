...
const cableCategories: CableCategorySeed[] = [
  { name: 'F-CV 전력케이블',       displayGroup: '전원',    sortOrder: 1 },
  { name: '난연/내화케이블',        displayGroup: '전원',    sortOrder: 2 },
  { name: '캡타이어 VCT',          displayGroup: '전원',    sortOrder: 3 },
  { name: '비닐절연전선 HIV',       displayGroup: '전원',    sortOrder: 4 },
  { name: 'UTP/S-FTP케이블',       displayGroup: '네트워크', sortOrder: 5 },
  { name: '광케이블',               displayGroup: '광',      sortOrder: 6 },
  { name: '광점퍼코드',             displayGroup: '광',      sortOrder: 7 },
  { name: '브레이크아웃케이블',     displayGroup: '광',      sortOrder: 8 },
  { name: 'OPGW(광복합가공지선)',   displayGroup: '광',      sortOrder: 9 },
  { name: '접지전선 IV/F-GV',       displayGroup: '접지',    sortOrder: 10 },
  { name: '나동연선',               displayGroup: '접지',    sortOrder: 11 },
  { name: '제어케이블 CVV-S',       displayGroup: '전원',    sortOrder: 12 },
  { name: '통신케이블 CPEV-S',      displayGroup: '네트워크', sortOrder: 13 },
  { name: 'PCM케이블',              displayGroup: '제어',    sortOrder: 14 },
  { name: '동축케이블',             displayGroup: '제어',    sortOrder: 15 },
  { name: '챔프케이블',             displayGroup: '네트워크', sortOrder: 16 },
  { name: '데이터/신호케이블',       displayGroup: '제어',    sortOrder: 17 },
];
...
export async function seedCableCategories(prisma: PrismaClient) {
  ...
  for (const cat of cableCategories) {
    const groupId = groupIdByName.get(cat.displayGroup) ?? null;
    if (!groupId) continue;
