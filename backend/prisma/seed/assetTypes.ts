...
export const ASSET_TYPE_SEEDS: AssetTypeSeed[] = [
  ...
  { code: 'DIST', name: '분전반', group: '전원', isContainer: true, displayColor: '#f59e0b', sortOrder: 30,
    placementKind: 'DIST',
    fieldTemplate: [] },
  { code: 'GROUNDING', name: '접지함체', group: '구조', isContainer: false, displayColor: '#84cc16', sortOrder: 31,
    placementKind: 'GROUNDING', fieldTemplate: [] },
  { code: 'HVAC', name: '공조설비', group: '공조', isContainer: false, displayColor: '#14b8a6', sortOrder: 32,
  ...
  { code: 'EQP-PITR-2000', name: 'PITR-2000', group: '통신', isContainer: false, displayColor: '#a855f7', sortOrder: 101, fieldTemplate: [] },
  { code: 'EQP-OPT-TERM',  name: '송변전광단말장치', group: '통신', isContainer: false, displayColor: '#a855f7', sortOrder: 102, fieldTemplate: [] },
  { code: 'EQP-PITR-5000', name: 'PITR-5000', group: '통신', isContainer: false, displayColor: '#a855f7', sortOrder: 103, fieldTemplate: [] },
  { code: 'EQP-NET-SW',    name: '네트워크스위치', group: '통신', isContainer: false, displayColor: '#3b82f6', sortOrder: 104, fieldTemplate: [] },
  { code: 'EQP-SPD',       name: '서지보호기', group: '통신', isContainer: false, displayColor: '#eab308', sortOrder: 105, fieldTemplate: [] },
  { code: 'EQP-SCADA',     name: 'SCADA', group: '통신', isContainer: false, displayColor: '#ef4444', sortOrder: 106, fieldTemplate: [] },
  { code: 'EQP-RTU',       name: 'RTU', group: '통신', isContainer: false, displayColor: '#ef4444', sortOrder: 107, fieldTemplate: [] },
  { code: 'EQP-UTM',       name: 'UTM', group: '통신', isContainer: false, displayColor: '#06b6d4', sortOrder: 108, fieldTemplate: [] },
  { code: 'EQP-NAC',       name: 'NAC', group: '통신', isContainer: false, displayColor: '#06b6d4', sortOrder: 109, fieldTemplate: [] },
  { code: 'EQP-UPS',       name: 'UPS', group: '통신', isContainer: false, displayColor: '#f97316', sortOrder: 110, fieldTemplate: [] },
  { code: 'EQP-CHARGER',   name: '충전기', group: '통신', isContainer: false, displayColor: '#f97316', sortOrder: 111, fieldTemplate: [] },
  { code: 'EQP-BATTERY',   name: '축전지', group: '통신', isContainer: false, displayColor: '#f97316', sortOrder: 112, fieldTemplate: [] },
  { code: 'EQP-PWR-AC',    name: '전원(AC)', group: '통신', isContainer: false, displayColor: '#f97316', sortOrder: 113, fieldTemplate: [] },
  { code: 'EQP-PWR-DC',    name: '전원(DC)', group: '통신', isContainer: false, displayColor: '#f97316', sortOrder: 114, fieldTemplate: [] },
];
